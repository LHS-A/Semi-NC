...
if __name__ == "__main__":
    import cv2
    label1 =cv2.imread(r"C:\Users\86178\Desktop\github_code\ModifiedHausdorffDistance-main2\ModifiedHausdorffDistance-main\src\HDQ(94).png",0)
    label2 = cv2.imread(r"C:\Users\86178\Desktop\github_code\ModifiedHausdorffDistance-main2\ModifiedHausdorffDistance-main\src\HDQ(104).png",0)
    hd95 = mhd_d23(label1, label2)
    print(hd95)